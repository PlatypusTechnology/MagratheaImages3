...
## -- date of creation: [2024-05-13 00:36:41]
...
class ApikeyBase extends MagratheaModel implements iMagratheaModel {
	...
	public $id, $private_key, $public_key, $folder, $uses, $usage_limit, $expiration, $active;
	...
	public function MagratheaStart(){
		...
		$this->dbValues["private_key"] = "string";
		$this->dbValues["public_key"] = "string";
	...
	public function GetControl() {
		return new \MagratheaImages3\Apikey\Base\ApikeyControlBase();
	}
